...
const Chat = ({ user }) => {
  ...
  // Professional quotes for banking/risk management context
  const quotes = [
      ...
      <div className="flex-1 flex flex-col">
              ...
              <div className="text-center max-w-lg">
                ...
                {dailyQuote && (
                  <div className="mt-6 p-4">
                    <p className="text-sm text-gray-700 italic">{dailyQuote}</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="px-4 py-2 bg-gray-50 border-t border-gray-200">
          <p className="text-xs text-gray-500 text-center">
            ⚠️ Do not share confidential customer information (CID). AI-generated responses should be reviewed for accuracy before use.
          </p>
        </div>
      </div>
