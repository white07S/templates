...
class MemoryCompressor:
    """Handles memory compression and extraction with performance optimizations."""
    ...
    async def compress_text(self, text: str, target_ratio: float = 5.0) -> str:
        ...
        try:
            # Use optimized client with compression caching
            compressed_text = await self.optimized_client.compress_text(
                text,
