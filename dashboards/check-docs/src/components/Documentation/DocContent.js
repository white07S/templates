  ...
  useEffect(() => {
    const loadDocument = async () => {
      ...
      try {
        ...
        const docData = await docsApi.getDocContent(docId);
        ...
        // Process MDX content using evaluate with proper configuration
        const { default: MDXComponent } = await evaluate(docData.content, {
          ...runtime,
        ...
        // Set the MDX component directly with components passed through evaluate
